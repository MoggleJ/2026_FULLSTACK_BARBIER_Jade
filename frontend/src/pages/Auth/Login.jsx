  ...
  return (
    <div className="auth-page">
      <div className="auth-card">
        ...
        <div className="auth-divider"><span>{t('auth.orWith')}</span></div>

        <div className="auth-oauth">
          <a href={`${API_URL}/auth/google`} className="btn-oauth btn-oauth--google">
          ...
          <a href={`${API_URL}/auth/github`} className="btn-oauth btn-oauth--github">
